...
$q="
    SELECT c.nume, c.prenume, v.producator, v.tip, com.suma FROM comanda com INNER JOIN vin v ON com.id_vin=v.id_vin JOIN client c ON com.id_client= c.id_client WHERE com.suma = '4.500' ";
