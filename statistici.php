...
$q="
SELECT DISTINCT vin.id_vin, vin.producator, vin.descriere, vin.tip, vin.pret, specificatie.efervescent, arespecificatie.valoare FROM vin  INNER JOIN arespecificatie ON vin.id_vin = arespecificatie.id_vin
INNER JOIN specificatie ON arespecificatie.id_specificatie = specificatie.id_specificatie WHERE vin.pret = (SELECT MAX(pret) FROM vin WHERE tip LIKE 'se%')";
