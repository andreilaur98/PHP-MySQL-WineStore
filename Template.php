<?php
require 'Controller/VinController.php';
...
if(isset($_POST['vinuri']))
    {
        ...
        $vinTables = $vinController->CreateVinTables($_POST['vinuri']);

    }

 else {
        $vinTables = $vinController->CreateAllVinTables();
      }
...
<div id="content_area">
    <?php echo $content = $vinController->CreateVinDropdownList().$vinTables; ?>
</div> 
...
$title = 'Wines';
echo $content = $vinController->CreateVinDropdownList().$vinTables;
